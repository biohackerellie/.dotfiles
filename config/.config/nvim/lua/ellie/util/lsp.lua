...
---@param name? string
function E.on_attach(func, name)
...
---@return boolean
function E.common_on_init(client)
...
function E.common_capabilities()
...
function E.resolve_config(...)
  local defaults = {
    on_init = E.common_on_init,
    capabilities = E.common_capabilities(),
  }
